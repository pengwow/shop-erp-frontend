...

  {
    ...
    children: [
      ...
      // 产品
      {
        ...
        component: RouteView,
        meta: { title: '产品', icon: 'shopping', permission: [ 'form' ] },
        children: [
          {
            path: '/product/list',
            name: 'ProductList',
      ...
      // 订单
      {
        ...
        redirect: '/orders',
        component: RouteView,
        meta: { title: '订单', icon: 'shopping', permission: [ 'form' ] },
        children: [
          {
            path: '/orders/home',
            name: 'OrdersList',
          ...
          },
          {
            path: '/orders/history',
            name: 'OrdersHistory',
            component: () => import('@/views/orders/OrdersHistory'),
            meta: { title: '历史订单', keepAlive: true, permission: [ 'form' ] }
          }
        ]
      },
      // forms
